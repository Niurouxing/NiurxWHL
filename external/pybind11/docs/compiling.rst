...
PyPI integration, can be found in the [mimo]_  repository.

.. [mimo] https://github.com/pybind/mimo
...
can refer to the same [mimo]_ repository for a full sample project
